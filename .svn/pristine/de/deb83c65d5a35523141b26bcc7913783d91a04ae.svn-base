    ...
    public partial class yoneticiler : System.Web.UI.Page
    {
        ...
        protected void Veriler(int Baslangic, int Bitis, string s, string Kolon, string AscDesc, out IList Sonuc1, out IList Sonuc2)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                try
                {
                    ...
                    #region İlk (Ham) SQL
                    var SQL1 = (from p in db.tbl_adminler
                                select new
                                {
                                    p.id,
                                    p.kullanici_adi,
                    ...
                    var SQL3 = SQL2.Skip(Baslangic).Take(Bitis).Select(p => new
                    {
                        ...
                        root = AdminClass.EvetHayir(p.root),
        ...
        protected void YeniKayitYap(object sender, DirectEventArgs e)
        {
            ...
            else
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    ...
                    ta.ad_soyad = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldAdiSoyadi.Text.Trim());
                    ta.kullanici_adi = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldKullaniciAdi.Text.Trim());
        ...
        protected void GuncellemeYap(object sender, DirectEventArgs e)
        {
            ...
            if (Guncelle)
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    ...
                    tbl_adminler ta = (from p in db.tbl_adminler where p.id == PID select p).FirstOrDefault();
                    ta.ad_soyad = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_TextFieldAdiSoyadi.Text.Trim());
        ...
        public void DM_OnayKaldir(int ID)
        {
            ...
            else
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    tbl_adminler ta = (from p in db.tbl_adminler where p.id == ID select p).FirstOrDefault();
