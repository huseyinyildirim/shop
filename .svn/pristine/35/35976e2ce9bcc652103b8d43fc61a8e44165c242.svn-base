<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="yoneticiler.aspx.cs" Inherits="SHOP.admin.yoneticiler" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
	...
	<script type="text/javascript"> 
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_adminler&kayit_id=" + record.data.id);
	                break;
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			...
			<ext:Window ID="WindowEkle" runat="server" Modal="false" Resizable="True" Height="500" Icon="Add" Title="Ekle" Width="640" Padding="5" Layout="FormLayout" ButtonAlign="Center" Shadow="None" LabelSeparator=" : " Draggable="True" AutoFocus="True" AutoHeight="True" Hidden="true">
				<Items>
					<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Ekle_TextFieldAdiSoyadi" MaxLength="150" MaxLengthText="Maksimum karakter sınırını aştınız." runat="server" FieldLabel="Adı Soyadı" BlankText="Lütfen kullanıcı adını ve soyadını yazın." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" />
					<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Ekle_TextFieldKullaniciAdi" MaxLength="150" MaxLengthText="Maksimum karakter sınırını aştınız." runat="server" FieldLabel="Kullanıcı Adı" BlankText="Lütfen kullanıcı adını yazın." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" />
					<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Ekle_TextFieldSifre" runat="server" FieldLabel="Şifre" BlankText="Lütfen bir şifre belirtin." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" InputType="Password" />
					<ext:ComboBox ID="Ekle_ComboBoxOnay" runat="server" FieldLabel="Onay" Editable="false" Selectable="true">
						<Items>
			...
			<ext:Window ID="WindowDuzenle" runat="server" Modal="true" Resizable="True" Height="500" Icon="NoteEdit" Title="Düzenle" Width="640" Padding="5" Layout="FormLayout" ButtonAlign="Center" Shadow="None" LabelSeparator=" : " Draggable="True" AutoFocus="True" AutoHeight="True" Hidden="true">
				<Items>
					...
					<ext:Panel ID="Panel1" runat="server" Layout="FormLayout" Padding="5" LabelSeparator=" : ">
						<Content>
							<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Duzenle_TextFieldAdiSoyadi" MaxLength="150" MaxLengthText="Maksimum karakter sınırını aştınız." runat="server" FieldLabel="Adı Soyadı" BlankText="Lütfen kullanıcı adını ve soyadını yazınız." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" />
							<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Duzenle_TextFieldKullaniciAdi" MaxLength="150" MaxLengthText="Maksimum karakter sınırını aştınız." runat="server" FieldLabel="Kullanıcı Adı" BlankText="Lütfen kullanıcı adını yazınız." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" />
						</Content>
					</ext:Panel>
