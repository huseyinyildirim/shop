...
{
    public partial class para_birim : System.Web.UI.Page
    {
        ...
        protected void Veriler(int Baslangic, int Bitis, string s, string Kolon, string AscDesc, out IList Sonuc1, out IList Sonuc2)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                try
                {
                    ...
                    #region İlk (Ham) SQL
                    var SQL1 = (from p in db.tbl_sbt_para_birim
                                select new
                                {
                                    p.id,
                                    p.ad,
                                    ...
                                    p.simge,
                                    p.uzunluk,
                                    sabit_kur = p.sabit_kur == true ? "EVET" : "HAYIR",
                                    hesaplama_tip = p.hesaplama_tip == true ? "EFEKTİF KUR" : "NORMAL KUR",
                                    p.hesaplama_birim,
                                    p.kur
                                });
                    #endregion
        ...
        public void GridPanelYuklenmedenOnce(Observable sender)
        {
            ...
            GridPanel1.Title = Window1.Title + " 'ne ait kayıtlar listeleniyor...";
        }
