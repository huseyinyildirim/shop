<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="markalara-atanan-urunler.aspx.cs" Inherits="SHOP.admin.markalara_atanan_urunler" EnableViewState="False" ViewStateMode="Disabled"
	...
	<script type="text/javascript"> 
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_urunler_markalar&kayit_id=" + record.data.id);
	                break;
