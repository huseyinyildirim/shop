...
namespace SHOP.admin
{
    public partial class etiketler : System.Web.UI.Page
    {
        ...
        protected void Veriler(int Baslangic, int Bitis, string s, string Kolon, string AscDesc, out IList Sonuc1, out IList Sonuc2)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                try
                {
                    ...
                    #region İlk (Ham) SQL
                    var SQL0 = (db.tbl_etiketler).AsEnumerable();
                    ...
                    var SQL3 = SQL2.Skip(Baslangic).Take(Bitis).Select(p => new
                    {
                        ...
                        p.admin_id_gun,
                        p.dil_id,
                        ziyaret = db.tbl_ziyaretler.Where(k => k.etiket_id == p.id).Count(),
        ...
        {
            if (!EtiketKontrol(Class.Fonksiyonlar.Genel.KarakterTemizle(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.TurkceKarakter, Ekle_TextFieldEtiket.Text.Trim()), false), int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxDil.Value.ToString().Trim()))))
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    ...
                    ta.ad = Class.Fonksiyonlar.Genel.KarakterTemizle(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.TurkceKarakter, Ekle_TextFieldEtiket.Text.Trim()), false);
            ...
            {
                Class.Fonksiyonlar.ExtJS.MesajKutusu(Icon.Error, MessageBox.Icon.ERROR, "İşlem başarısız", "Aynı etiketten mevcut.<br/>Lütfen farklı bir etiket belirtin!");
                return;
            }
        }
        ...
        public void DM_GuncellemeEkraniGetir(int ID)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL2 = (from p in db.tbl_etiketler
                            where p.id == ID
                            select new
                            {
                                p.dil_id,
        ...
        protected void GuncellemeYap(object sender, DirectEventArgs e)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                ...
                ta.ad = Class.Fonksiyonlar.Genel.KarakterTemizle(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.TurkceKarakter, Duzenle_TextFieldEtiket.Text.Trim()), false);
                ta.anasayfa = Class.Fonksiyonlar.Genel.Cevirmeler.StringToBool(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxAnasayfa.Value.ToString().Trim()));
                ta.onay = OnayBool;
                ta.admin_id_gun = Class.Fonksiyonlar.Admin.Genel.AdminID();

                if (Duzenle_Etiket.Text != Class.Fonksiyonlar.Genel.KarakterTemizle(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.TurkceKarakter, Duzenle_TextFieldEtiket.Text.Trim()), false))
                {
                    if (!EtiketKontrol(Class.Fonksiyonlar.Genel.KarakterTemizle(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.TurkceKarakter, Duzenle_TextFieldEtiket.Text.Trim()), false), int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxDil.Value.ToString().Trim()))))
                    {
                        db.SaveChanges();
        ...
        public void DM_OnayKaldir(int ID)
        {
            ...
            else
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    tbl_etiketler ta = (from p in db.tbl_etiketler where p.id == ID select p).FirstOrDefault();
