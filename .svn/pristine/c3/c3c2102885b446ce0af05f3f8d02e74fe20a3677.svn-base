<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menuler.aspx.cs" Inherits="SHOP.admin.menuler" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False"
	...
	<script type="text/javascript"> 
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_menuler&kayit_id=" + record.data.id);
	                break;
