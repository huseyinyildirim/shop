<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="brand.aspx.cs" Inherits="SHOP.brand"
        ...
        <div class="icerikcerceve">
            ...
            <div id="ortablok">
                ...
                <asp:ListView runat="server" ID="list_urunler">
                    ...
                    <EmptyDataTemplate>
                        <%Response.Write(SHOP.Class.Fonksiyonlar.Uygulama.SabitlerText(243));%></EmptyDataTemplate>
                </asp:ListView>
