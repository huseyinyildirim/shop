<%@ Page Language="C#" AutoEventWireup="true" Inherits="Moduler.posnettds" CodeFile="posnettds.aspx.cs"
...
<body>
    <form id="formName" runat="server" name="formName" action="http://setmpos.ykb.com/3DSWebService/YKBPaymentService" method="post">
    <br />
    <br />
    <br />
    <center>
