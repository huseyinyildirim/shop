...
INSERT INTO `tbl_cpy_odeme_bildirimler_hesap_nolar` VALUES (1,1,1,'K','488','FATİH ','1234567890','TR01234567890102345678965255555555',NULL,'2012-03-26 23:03:01');
...
CREATE TABLE `tbl_cpy_siparisler_kullanicilar_adresler` (
  ...
  KEY `ilce_id` (`ilce_id`) USING BTREE
...
INSERT INTO `tbl_cpy_siparisler_kullanicilar_adresler` VALUES (2,4,1,1,'ddd',235,NULL,'',NULL,'',NULL,NULL,'',NULL,'2012-03-28 00:49:48'),(3,2,1,0,'1',235,'deneme eyalet','deneme il',NULL,'deneme ilce',NULL,'43020','bla bla','öz bla bla','2012-03-28 00:49:53'),(4,4,1,1,'ddd',235,NULL,'',NULL,'',NULL,NULL,'',NULL,'2012-04-22 01:30:06'),(5,2,1,0,'1',235,'deneme eyalet','deneme il',NULL,'deneme ilce',NULL,'43020','bla bla','öz bla bla','2012-04-22 01:30:06'),(6,4,4,1,'ddd',235,NULL,'',NULL,'',NULL,NULL,'',NULL,'2012-04-22 01:33:07'),(7,2,4,0,'1',235,'deneme eyalet','deneme il',NULL,'deneme ilce',NULL,'43020','bla bla','öz bla bla','2012-04-22 01:33:07'),(8,2,4,0,'1',235,'deneme eyalet','deneme il',NULL,'deneme ilce',NULL,'43020','bla bla','öz bla bla','2012-04-22 01:34:22'),(9,3,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2012-04-22 01:34:23'),(10,4,4,1,'ddd',235,NULL,'',NULL,'',NULL,NULL,'',NULL,'2012-04-22 01:34:24'),(11,5,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2012-04-22 01:34:26');
...
CREATE TABLE `tbl_cpy_siparisler_kullanicilar_vergi_bilgiler` (
  ...
  `tip` tinyint(1) DEFAULT NULL COMMENT '0 ki',
  ...
  KEY `kullanici_id` (`kullanici_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='KOPYA TABLOSU';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_cpy_siparisler_kullanicilar_vergi_bilgiler` VALUES (2,1,1,NULL,0,'-','-','14141311255','2012-03-28 00:54:15'),(4,1,1,2,0,'-','-','14141311255','2012-04-13 02:12:07'),(5,1,1,2,0,'-','-','14141311255','2012-04-22 01:30:06'),(6,1,4,2,0,'-','-','14141311255','2012-04-22 01:33:07');
...
INSERT INTO `tbl_cpy_siparisler_urunler` VALUES (12,35,999,'T',1,'SER-000',115,'product_01.jpg',NULL,NULL,2,'VIDEO - BOŞ KATEGORİ','DENEME ','DENEME ','<table summary=\"\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\" width=\"100%\">\n<tbody>\n\n<tr>\n<td class=\"tdb\" width=\"135\"><strong>Model</strong></td>\n<td><strong>SerasMac</strong><strong> 1512 Lazer Kesim Makinesi</strong></td>\n</tr>\n\n<tr>\n<td class=\"tdb\" width=\"135\">',NULL,NULL,NULL,NULL,NULL,1.00000,1,1,1,1,'KDV BİZDEN %18',1.180,'2012-03-28 00:23:45');
...
CREATE TABLE `tbl_kullanicilar_adresler` (
  ...
  KEY `il_id` (`il_id`) USING BTREE,
  KEY `ilce_id` (`ilce_id`) USING BTREE,
  CONSTRAINT `tbl_kullanicilar_adresler_ibfk_1` FOREIGN KEY (`ilce_id`) REFERENCES `tbl_sbt_ulke_ilce` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tbl_kullanicilar_adresler_ibfk_2` FOREIGN KEY (`il_id`) REFERENCES `tbl_sbt_ulke_il` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tbl_kullanicilar_adresler_ibfk_3` FOREIGN KEY (`kullanici_id`) REFERENCES `tbl_kullanicilar` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tbl_kullanicilar_adresler_ibfk_4` FOREIGN KEY (`ulke_id`) REFERENCES `tbl_sbt_ulke` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_kullanicilar_adresler` VALUES (2,4,0,'1',235,'deneme eyalet','deneme il',NULL,'deneme ilce',NULL,'43020','bla bla','öz bla bla','2012-03-28 00:49:17','2012-04-22 01:32:36'),(4,4,1,'ddd',235,NULL,'',NULL,'',NULL,NULL,'',NULL,'2012-03-28 00:49:39','2012-04-22 01:32:37');
...
CREATE TABLE `tbl_kullanicilar_vergi_bilgiler` (
  ...
  `kullanici_id` int(11) NOT NULL DEFAULT '-1',
  `adres_id` int(11) DEFAULT NULL,
  `tip` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0 ki',
  `vergi_dairesi` varchar(255) DEFAULT NULL,
  ...
  `tarih_gun` datetime DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `kullanici_id` (`kullanici_id`) USING BTREE,
  KEY `id` (`id`) USING BTREE,
  KEY `tarih_ek` (`tarih_ek`) USING BTREE,
  KEY `tarih_gun` (`tarih_gun`) USING BTREE,
  KEY `tip` (`tip`) USING BTREE,
...
INSERT INTO `tbl_kullanicilar_vergi_bilgiler` VALUES (1,4,2,0,'-','-','14141311255','2012-03-26 22:42:26','2012-04-22 01:32:51');
...
CREATE TABLE `tbl_sbt_ulke` (
  ...
  KEY `bolge_id` (`bolge_id`) USING BTREE,
  CONSTRAINT `tbl_sbt_ulke_ibfk_1` FOREIGN KEY (`bolge_id`) REFERENCES `tbl_sbt_ulke_bolge` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tbl_sbt_ulke` VALUES (1,10,'Afghanistan',NULL,'AF',NULL),(2,10,'Albania',NULL,'AL',355),(3,1,'Algeria',NULL,'DZ',213),(4,9,'American Samoa',NULL,'AS',NULL),(5,10,'Andorra',NULL,'AD',376),(6,1,'Angola',NULL,'AO',244),(7,5,'Anguilla',NULL,'AI',1),(8,9,'Antarctica',NULL,'AQ',NULL),(9,5,'Antigua & Barbuda',NULL,'AG',1),(10,10,'Antilles, Netherlands',NULL,'AN',599),(11,8,'Saudi Arabia',NULL,'SA',966),(12,3,'Argentina',NULL,'AR',54),(13,6,'Armenia',NULL,'AM',374),(14,5,'Aruba',NULL,'AW',297),(15,9,'Australia',NULL,'AU',61),(16,10,'Austria',NULL,'AT',43),(17,6,'Azerbaijan',NULL,'AZ',994),(18,10,'Bahamas, The',NULL,'BS',1),(19,8,'Bahrain',NULL,'BH',973),(20,6,'Bangladesh',NULL,'BD',NULL),(21,5,'Barbados',NULL,'BB',1),(22,10,'Belarus',NULL,'BY',NULL),(23,7,'Belgium',NULL,'BE',32),(24,4,'Belize',NULL,'BZ',501),(25,1,'Benin',NULL,'BJ',229),(26,2,'Bermuda',NULL,'BM',1),(27,6,'Bhutan',NULL,'BT',975),(28,3,'Bolivia',NULL,'BO',591),(29,10,'Bosnia and Herzegovina',NULL,'BA',387),(30,1,'Botswana',NULL,'BW',267),(31,10,'Bouvet Island',NULL,'BV',NULL),(32,3,'Brazil',NULL,'BR',55),(33,10,'British Indian Ocean T.',NULL,'IO',NULL),(34,5,'British Virgin Islands',NULL,'VG',1),(35,10,'Brunei Darussalam',NULL,'BN',673),(36,7,'Bulgaria',NULL,'BG',359),(37,1,'Burkina Faso',NULL,'BF',226),(38,1,'Burundi',NULL,'BI',257),(39,6,'Cambodia',NULL,'KH',855),(40,1,'Cameroon',NULL,'CM',NULL),(41,2,'Canada',NULL,'CA',1),(42,1,'Cape Verde',NULL,'CV',238),(43,5,'Cayman Islands',NULL,'KY',1),(44,10,'Central African Republic',NULL,'CF',NULL),(45,1,'Chad',NULL,'TD',235),(46,3,'Chile',NULL,'CL',56),(47,6,'China',NULL,'CN',NULL),(48,9,'Christmas Island',NULL,'CX',NULL),(49,10,'Cocos (Keeling) Islands',NULL,'CC',NULL),(50,3,'Colombia',NULL,'CO',57),(51,1,'Comoros',NULL,'KM',269),(52,1,'Congo',NULL,'CG',242),(53,10,'Congo, Dem. Rep. of the',NULL,'CD',243),(54,9,'Cook Islands',NULL,'CK',682),(55,4,'Costa Rica',NULL,'CR',506),(56,1,'Cote D\'Ivoire',NULL,'CI',NULL),(57,10,'Croatia',NULL,'HR',385),(58,5,'Cuba',NULL,'CU',NULL),(59,10,'Cyprus',NULL,'CY',357),(60,10,'Czech Republic',NULL,'CZ',420),(61,7,'Denmark',NULL,'DK',45),(62,1,'Djibouti',NULL,'DJ',253),(63,5,'Dominica',NULL,'DM',1),(64,5,'Dominican Republic',NULL,'DO',1),(65,10,'East Timor (Timor-Leste)',NULL,'TP',NULL),(66,3,'Ecuador',NULL,'EC',593),(67,1,'Egypt',NULL,'EG',NULL),(68,4,'El Salvador',NULL,'SV',503),(69,1,'Equatorial Guinea',NULL,'GQ',NULL),(70,1,'Eritrea',NULL,'ER',291),(71,10,'Estonia',NULL,'EE',372),(72,1,'Ethiopia',NULL,'ET',251),(73,10,'European Union',NULL,'EU',NULL),(74,10,'Falkland Islands (Malvinas)',NULL,'FK',500),(75,10,'Faroe Islands',NULL,'FO',298),(76,9,'Fiji',NULL,'FJ',679),(77,10,'Finland',NULL,'FI',358),(78,7,'France',NULL,'FR',33),(79,3,'French Guiana',NULL,'GF',594),(80,9,'French Polynesia',NULL,'PF',689),(81,10,'French Southern Terr.',NULL,'TF',NULL),(82,1,'Gabon',NULL,'GA',241),(83,10,'Gambia, the',NULL,'GM',220),(84,6,'Georgia',NULL,'GE',NULL),(85,7,'Germany',NULL,'DE',49),(86,1,'Ghana',NULL,'GH',NULL),(87,10,'Gibraltar',NULL,'GI',350),(88,7,'Greece',NULL,'GR',30),(89,2,'Greenland',NULL,'GL',299),(90,5,'Grenada',NULL,'GD',1),(91,5,'Guadeloupe',NULL,'GP',590),(92,9,'Guam',NULL,'GU',NULL),(93,4,'Guatemala',NULL,'GT',502),(94,10,'Guernsey and Alderney',NULL,'GG',NULL),(95,10,'Guiana, French',NULL,'GF',594),(96,1,'Guinea',NULL,'GN',224),(97,1,'Guinea-Bissau',NULL,'GW',245),(98,10,'Guinea, Equatorial',NULL,'GP',590),(99,3,'Guyana',NULL,'GY',592),(100,5,'Haiti',NULL,'HT',NULL),(101,10,'Heard & McDonald Is.(AU)',NULL,'HM',NULL),(102,10,'Holy See (Vatican)',NULL,'VA',379),(103,4,'Honduras',NULL,'HN',504),(104,10,'Hong Kong, (China)',NULL,'HK',852),(105,10,'Hungary',NULL,'HU',36),(106,10,'Iceland',NULL,'IS',354),(107,6,'India',NULL,'IN',91),(108,6,'Indonesia',NULL,'ID',62),(109,10,'Iran, Islamic Republic of',NULL,'IR',NULL),(110,8,'Iraq',NULL,'IQ',NULL),(111,10,'Ireland',NULL,'IE',353),(112,8,'Israel',NULL,'IL',972),(113,10,'Italy',NULL,'IT',39),(114,10,'Ivory Coast (Cote d\'Ivoire)',NULL,'CI',NULL),(115,5,'Jamaica',NULL,'JM',1),(116,6,'Japan',NULL,'JP',81),(117,10,'Jersey',NULL,'JE',NULL),(118,8,'Jordan',NULL,'JO',962),(119,6,'Kazakhstan',NULL,'KZ',7),(120,1,'Kenya',NULL,'KE',254),(121,9,'Kiribati',NULL,'KI',686),(122,10,'Korea Dem. People\'s Rep.',NULL,'KP',NULL),(123,10,'Korea, (South) Republic of',NULL,'KR',82),(124,10,'Kosovo',NULL,'KV',NULL),(125,8,'Kuwait',NULL,'KW',965),(126,10,'Kyrgyzstan',NULL,'KG',996),(127,10,'Lao People\'s Democ. Rep.',NULL,'LA',856),(128,10,'Latvia',NULL,'LV',371),(129,8,'Lebanon',NULL,'LB',NULL),(130,1,'Lesotho',NULL,'LS',266),(131,1,'Liberia',NULL,'LR',NULL),(132,10,'Libyan Arab Jamahiriya',NULL,'LY',NULL),(133,10,'Liechtenstein',NULL,'LI',423),(134,10,'Lithuania',NULL,'LT',370),(135,10,'Luxembourg',NULL,'LU',352),(136,10,'Macao, (China)',NULL,'MO',NULL),(137,10,'Macedonia, TFYR',NULL,'MK',NULL),(138,1,'Madagascar',NULL,'MG',261),(139,1,'Malawi',NULL,'MW',265),(140,6,'Malaysia',NULL,'MY',60),(141,6,'Maldives',NULL,'MV',960),(142,1,'Mali',NULL,'ML',223),(143,10,'Malta',NULL,'MT',356),(144,10,'Man, Isle of',NULL,'IM',NULL),(145,9,'Marshall Islands',NULL,'MH',692),(146,10,'Martinique (FR)',NULL,'MQ',596),(147,1,'Mauritania',NULL,'MR',222),(148,1,'Mauritius',NULL,'MU',230),(149,1,'Mayotte (FR)',NULL,'YT',269),(150,4,'Mexico',NULL,'MX',52),(151,10,'Micronesia, Fed. States of',NULL,'FM',691),(152,10,'Moldova, Republic of',NULL,'MD',NULL),(153,10,'Monaco',NULL,'MC',NULL),(154,6,'Mongolia',NULL,'MN',976),(155,10,'Montenegro',NULL,'CS',NULL),(156,10,'Montserrat',NULL,'MS',1),(157,1,'Morocco',NULL,'MA',212),(158,1,'Mozambique',NULL,'MZ',258),(159,10,'Myanmar (ex-Burma)',NULL,'MM',NULL),(160,1,'Namibia',NULL,'NA',264),(161,9,'Nauru',NULL,'NR',674),(162,6,'Nepal',NULL,'NP',977),(163,7,'Netherlands',NULL,'NL',31),(164,5,'Netherlands Antilles',NULL,'AN',599),(165,9,'New Caledonia',NULL,'NC',687),(166,9,'New Zealand',NULL,'NZ',64),(167,4,'Nicaragua',NULL,'NI',505),(168,1,'Niger',NULL,'NE',227),(169,1,'Nigeria',NULL,'NG',NULL),(170,9,'Niue',NULL,'NU',683),(171,9,'Norfolk Island',NULL,'NF',672),(172,10,'Northern Mariana Islands',NULL,'MP',NULL),(173,10,'Norway',NULL,'NO',47),(174,8,'Oman',NULL,'OM',968),(175,6,'Pakistan',NULL,'PK',NULL),(176,9,'Palau',NULL,'PW',680),(177,10,'Palestinian Territory',NULL,'PS',NULL),(178,4,'Panama',NULL,'PA',507),(179,10,'Papua New Guinea',NULL,'PG',675),(180,3,'Paraguay',NULL,'PY',NULL),(181,3,'Peru',NULL,'PE',51),(182,6,'Philippines',NULL,'PH',63),(183,10,'Pitcairn Island',NULL,'PN',872),(184,7,'Poland',NULL,'PL',48),(185,7,'Portugal',NULL,'PT',351),(186,5,'Puerto Rico',NULL,'PR',NULL),(187,8,'Qatar',NULL,'QA',974),(188,1,'Reunion (FR)',NULL,'RE',262),(189,7,'Romania',NULL,'RO',40),(190,10,'Russia (Russian Fed.)',NULL,'RU',7),(191,1,'Rwanda',NULL,'RW',250),(192,10,'Sahara, Western',NULL,'EH',NULL),(193,10,'Saint Barthelemy (FR)',NULL,'BL',NULL),(194,1,'Saint Helena (UK)',NULL,'SH',290),(195,10,'Saint Kitts and Nevis',NULL,'KN',1),(196,5,'Saint Lucia',NULL,'LC',1),(197,10,'Saint Martin (FR)',NULL,'MF',NULL),(198,10,'S Pierre & Miquelon(FR)',NULL,'PM',508),(199,10,'S Vincent & Grenadines',NULL,'VC',1),(200,9,'Samoa',NULL,'WS',685),(201,10,'San Marino',NULL,'SM',378),(202,10,'Sao Tome and Principe',NULL,'ST',239),(203,8,'Saudi Arabia',NULL,'SA',966),(204,1,'Senegal',NULL,'SN',221),(205,10,'Serbia',NULL,'RS',NULL),(206,1,'Seychelles',NULL,'SC',248),(207,1,'Sierra Leone',NULL,'SL',232),(208,6,'Singapore',NULL,'SG',65),(209,10,'Slovakia',NULL,'SK',421),(210,10,'Slovenia',NULL,'SI',386),(211,9,'Solomon Islands',NULL,'SB',677),(212,1,'Somalia',NULL,'SO',252),(213,1,'South Africa',NULL,'ZA',27),(214,10,'S.George & S.Sandwich',NULL,'GS',NULL),(215,1,'South Sudan',NULL,'SS',NULL),(216,7,'Spain',NULL,'ES',34),(217,10,'Sri Lanka (ex-Ceilan)',NULL,'LK',94),(218,1,'Sudan',NULL,'SD',NULL),(219,3,'Suriname',NULL,'SR',597),(220,10,'Svalbard & Jan Mayen Is.',NULL,'SJ',47),(221,1,'Swaziland',NULL,'SZ',268),(222,10,'Sweden',NULL,'SE',46),(223,10,'Switzerland',NULL,'CH',41),(224,10,'Syrian Arab Republic',NULL,'SY',NULL),(225,6,'Taiwan',NULL,'TW',886),(226,6,'Tajikistan',NULL,'TJ',992),(227,10,'Tanzania, United Rep. of',NULL,'TZ',255),(228,6,'Thailand',NULL,'TH',66),(229,10,'Timor-Leste (East Timor)',NULL,'TL',NULL),(230,1,'Togo',NULL,'TG',228),(231,9,'Tokelau',NULL,'TK',NULL),(232,9,'Tonga',NULL,'TO',676),(233,5,'Trinidad & Tobago',NULL,'TT',1),(234,1,'Tunisia',NULL,'TN',216),(235,7,'Türkiye',NULL,'TR',90),(236,6,'Turkmenistan',NULL,'TM',993),(237,10,'Turks and Caicos Is.',NULL,'TC',1),(238,9,'Tuvalu',NULL,'TV',688),(239,1,'Uganda',NULL,'UG',256),(240,10,'Ukraine',NULL,'UA',380),(241,8,'United Arab Emirates',NULL,'AE',971),(242,7,'United Kingdom',NULL,'UK',NULL),(243,2,'United States','EN','US',1),(244,10,'US Minor Outlying Isl.',NULL,'UM',NULL),(245,3,'Uruguay',NULL,'UY',598),(246,6,'Uzbekistan',NULL,'UZ',NULL),(247,9,'Vanuatu',NULL,'VU',678),(248,10,'Vatican (Holy See)',NULL,'VA',379),(249,3,'Venezuela',NULL,'VE',58),(250,6,'Vietnam',NULL,'VN',84),(251,10,'Virgin Islands, British',NULL,'VG',1),(252,10,'Virgin Islands, U.S.',NULL,'VI',NULL),(253,10,'Wallis and Futuna',NULL,'WF',681),(254,1,'Western Sahara',NULL,'EH',NULL),(255,8,'Yemen',NULL,'YE',967),(256,1,'Zambia',NULL,'ZM',260),(257,1,'Zimbabwe',NULL,'ZW',NULL);
...
INSERT INTO `tbl_sbt_ulke_bolge` VALUES (1,'AFRIKA'),(2,'KUZEY AMERIKA'),(3,'GUNEY AMERIKA'),(4,'ORTA AMERIKA'),(5,'KARAYIPLER'),(6,'ASYA'),(7,'AVRUPA'),(8,'ORTADOGU'),(9,'OKYANUSYA'),(10,'DİĞER');
...
INSERT INTO `tbl_siparis_durumlar` VALUES (10,999,10,'ALICI BULUNAMADI. SİPARİŞ İPTAL EDİLDİ.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:48'),(11,999,1,'HAZIRLANIYOR.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:47'),(22,999,2,'ÖDEME BEKLENİYOR.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:46'),(33,999,3,'ÖDEME TAMAMLANDI. ÜRÜN(LER) TEDARİK SÜRECİNDE.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:45'),(44,999,4,'TAŞIMA (KARGO) FİRMASINA VERİLDİ.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:45'),(55,999,5,'ÜRÜN(LER) TESLİM EDİLDİ.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:44'),(66,999,6,'ÖDEME GERÇEKLEŞMEDİ. SİPARİŞ İPTAL EDİLDİ.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:43'),(77,999,7,'ADRES BİLGİSİ YANLIŞ. SİPARİŞ İPTAL EDİLDİ.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:42'),(88,999,8,'KARGO TESLİM EDİLEMEDİ. ',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:41'),(99,999,9,'SİPARİŞ YENİDEN KARGOYA VERİLDİ.',1,999,'2012-03-26 01:14:01',999,'2012-04-21 18:58:40');
...
INSERT INTO `tbl_siparisler` VALUES (4,1,'',1,1,2,3,2,1500.00000,2,150.00000,1350.00000,243.00000,25.00000,1618.00000,1,2,'2012-03-28 01:34:06',NULL,NULL);
...
INSERT INTO `tbl_siparisler_gonderimler` VALUES (1,4,1,'123456',999,'2012-03-28 01:34:26',NULL,NULL);
...
CREATE TABLE `tbl_siparisler_odemeler_kk` (
  ...
  KEY `toplam_tutar` (`toplam_tutar`) USING BTREE,
  KEY `para_birimi_id` (`para_birimi_id`) USING BTREE,
  KEY `sanal_pos_id` (`sanal_pos_id`) USING BTREE,
  ...
  CONSTRAINT `tbl_siparisler_odemeler_kk_ibfk_4` FOREIGN KEY (`sanal_pos_id`) REFERENCES `tbl_sanal_poslar` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `tbl_siparisler_odemeler_kk_ibfk_5` FOREIGN KEY (`siparis_id`) REFERENCES `tbl_siparisler` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_siparisler_odemeler_kk` VALUES (1,1,4,1,'FATİH ','','',2,25.00000,1643.00000,1,'2012-03-28 01:36:03');
...
INSERT INTO `tbl_siparisler_urunler` VALUES (1,4,12,10,'2012-03-28 01:37:15');
...
-- Dump completed on 2012-04-22  1:38:58
