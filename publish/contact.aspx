<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="SHOP.contact"
    ...
    <div class="icerik">
        <div class="icerikcerceve">
            ...
            <div id="ortablok">
                ...
                <asp:Literal runat="server" ID="lit_adres" />
                <div class="h10">
                </div>
                <div class="h10">
                </div>
                <div id="ortablokbaslik2">
                    <asp:Literal runat="server" ID="lit_ortabaslik2" /></div>
                <div class="h10">
                </div>
                <table summary="">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Button ID="btn_iletisim_gonder" runat="server" OnClick="btn_iletisim_gonder_Click"
