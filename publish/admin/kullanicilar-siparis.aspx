<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kullanicilar-siparis.aspx.cs"
    Inherits="SHOP.admin.dummy.kullanicilar_siparis" EnableViewState="False" ViewStateMode="Disabled"
                ...
                <ColumnModel ID="ColumnModel1" runat="server">
                    <Columns>
                        <ext:RowNumbererColumn MenuDisabled="true" ColumnID="check" Resizable="false" Editable="false"
                            Width="55" />
                        <ext:Column DataIndex="no" Header="Sipariş No" />
                        <ext:Column DataIndex="toplam" Header="Toplam" />
                        <ext:Column DataIndex="para_birimi" Header="Para Birimi" />
                        <ext:Column DataIndex="odeme_sekli" Header="Ödeme Şekli" />
                        <ext:DateColumn DataIndex="tarih" Header="Tarih" Format="dd/MM/yyyy - HH:mm:ss" Width="125" />
                        <ext:Column DataIndex="kargo" Header="Kargo Firması" />
                        <ext:Column DataIndex="durum" Header="Durumu" />
                    </Columns>
                </ColumnModel>
                <Plugins>
                    <ext:GridFilters runat="server" ID="GridFilters1" Local="true">
                        <Filters>
                            ...
                            <ext:StringFilter DataIndex="toplam" />
                            <ext:StringFilter DataIndex="para_birimi" />
                            <ext:StringFilter DataIndex="odeme_sekli" />
                            <ext:StringFilter DataIndex="kargo" />
                            <ext:StringFilter DataIndex="durum" />
