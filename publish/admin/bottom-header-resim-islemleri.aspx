<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bottom-header-resim-islemleri.aspx.cs" Inherits="SHOP.admin.bottom_header_resim_islemleri"
...
<body>
	...
	<script type="text/javascript"> 
	    var OtherYol = function (data) {
	        return String.format("<a href=\"" + data.replace(data, "../userfiles/other/" + data) + "\" target=\"_blank\">" + data + "</a>");
	    }; 
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_ikonlar&kayit_id=" + record.data.id);
	                break;
