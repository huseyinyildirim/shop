<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="etiketler.aspx.cs" Inherits="SHOP.admin.etiketler" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False"
	...
	<script type="text/javascript">
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_etiketler&kayit_id=" + record.data.id);
	                break;
