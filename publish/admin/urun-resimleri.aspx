<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="urun-resimleri.aspx.cs"
    Inherits="SHOP.admin.urun_resimleri" EnableViewState="False" ViewStateMode="Disabled"
...
<body>
    ...
    <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
        <Items>
            <ext:Window ID="Window1" runat="server" Maximized="true" Title="Ürün Resimleri [K]"
                Layout="FitLayout" Icon="Picture" Closable="false" Minimizable="false" MinHeight="480"
                MinWidth="640">
                <Items>
