<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iletisimden-gelen-mailler.aspx.cs" Inherits="SHOP.admin.iletisimden_gelen_mailler" EnableViewState="False" ViewStateMode="Disabled"
	        ...
	        switch (cmd) {
	            case "Okundu":
	                Ext.Msg.confirm('Uyarı', 'Seçilen kaydı okundu olarak işaretle?', function (btn) {
	                    if (btn == "yes") {
	                        Ext.net.DirectMethods.DM_Oku(record.data.id);
	                    }
	                });
	                break;

	            case "Oku":
	                Ext.net.DirectMethods.DM_OkumaEkraniGetir(record.data.id);
	                break;
	        }
	    }
	</script>
