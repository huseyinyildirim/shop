<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="isleme-ait-kayitlar.aspx.cs" Inherits="SHOP.admin.isleme_ait_kayitlar" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
