<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bankalar.aspx.cs" Inherits="SHOP.admin.bankalar" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
...
<script src="js/js.js" type="text/javascript"></script>
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Bankalar" Layout="FitLayout" Icon="Neighbourhood" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString" AutoExpandColumn="ad"
						...
						<ColumnModel runat="server">
							<Columns>
								...
								<ext:Column DataIndex="ad" Header="Banka" />
								<ext:Column DataIndex="marka" Header="Marka" />
								<ext:Column DataIndex="ikon" Header="İkon" />
								<ext:Column DataIndex="ikon2" Header="İkon Yol" Hidden="true" MenuDisabled="true" Sortable="false">
									<Renderer Fn="IkonYol" />
								</ext:Column>
								<ext:Column DataIndex="renk" Header="Renk" Width="60" Resizable="false"/>
								<ext:Column DataIndex="renk" Header="Renk Test" Width="60" Resizable="false" Hidden="true" MenuDisabled="true" Sortable="false">
								<Renderer Fn="RenkTest" />
								</ext:Column>
							</Columns>
						</ColumnModel>
						<Plugins>
							<ext:GridFilters runat="server" ID="GridFilters1" Local="true">
								<Filters>
									...
									<ext:StringFilter DataIndex="renk" />
