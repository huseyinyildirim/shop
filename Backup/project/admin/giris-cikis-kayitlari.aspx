<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="giris-cikis-kayitlari.aspx.cs" Inherits="SHOP.admin.giris_cikis_kayitlari" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
	...
	<script type="text/javascript">
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "TumBilgiler":
	                PencereGetir("WindowT" + record.data.id, "icon-usermagnify", "Ziyaret Bilgileri Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "ziyaret-bilgi.aspx?tablo_adi=tbl_giris_cikislar&kayit_id=" + record.data.id); 
	                break;
	        }
	    }
	</script>
