<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="odeme-sekli.aspx.cs" Inherits="SHOP.admin.odeme_sekli" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
...
<script src="js/js.js" type="text/javascript"></script>
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Ödeme Şekli" Layout="FitLayout" Icon="Neighbourhood" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
