...
{
    public partial class haber_resimleri : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    VerileriGetir();
                    Label2.Html = "İlgili resimler " + "<b><u>" + Class.Degiskenler.Site.Yollar.Haber + "</u></b>" + " klasöründen gösterilmektedir.";
                }
                #endregion
            }
            #endregion
        ...
        {
            Resimler = AdminClass.ResimleriGetir(Class.Degiskenler.Site.Yollar.Haber, "N");
        }
