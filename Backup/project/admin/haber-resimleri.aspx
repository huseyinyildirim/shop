<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="haber-resimleri.aspx.cs"
    Inherits="SHOP.admin.haber_resimleri" EnableViewState="False" ViewStateMode="Disabled"
...
<body>
    ...
    <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
        <Items>
            <ext:Window ID="Window1" runat="server" Maximized="true" Title="Haber Resimleri [K]"
                Layout="FitLayout" Icon="FeedLink" Closable="false" Minimizable="false" MinHeight="480"
                MinWidth="640">
                <Items>
