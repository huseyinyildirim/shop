<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indirimler-komisyonlar.aspx.cs" Inherits="SHOP.admin.indirimler_komisyonlar" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
...
<script src="js/js.js" type="text/javascript"></script>
	<script type="text/javascript"> 
	    ...
	    var DuzenleKontrol = function () {
	        ...
	        else if (!Duzenle_TextFieldYuzde.validate()) {
	            Ext.Msg.show({ title: 'Hata', msg: 'Lütfen zorunlu tüm alanları doldurun.', buttons: Ext.Msg.OK, icon: Ext.Msg.ERROR });
	            return false;
	        }
	        else if (Duzenle_ComboBoxOdemeSekli.getValue() == "Ödeme Şeklini Seçiniz..." || Duzenle_ComboBoxOdemeSekli.getValue() == "[]" || Duzenle_ComboBoxOdemeSekli.getValue() == "") {
	            Ext.Msg.show({ title: 'Hata', msg: 'Lütfen ödeme şeklini seçin.', buttons: Ext.Msg.OK, icon: Ext.Msg.ERROR });
	            return false;
	        }
	    }
	    ...
	    var KaydetKontrol = function () {
	        ...
	        else if (!Ekle_TextFieldYuzde.validate()) {
	            Ext.Msg.show({ title: 'Hata', msg: 'Lütfen zorunlu tüm alanları doldurun.', buttons: Ext.Msg.OK, icon: Ext.Msg.ERROR });
	            return false;
	        }
	        else if (Ekle_ComboBoxOdemeSekli.getValue() == "Ödeme Şeklini Seçiniz..." || Ekle_ComboBoxOdemeSekli.getValue() == "[]" || Ekle_ComboBoxOdemeSekli.getValue() == "") {
	            Ext.Msg.show({ title: 'Hata', msg: 'Lütfen ödeme şeklini seçin.', buttons: Ext.Msg.OK, icon: Ext.Msg.ERROR });
	            return false;
	        }
	    }
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_indirimler_komisyonlar&kayit_id=" + record.data.id);
	                break;
	...
	<ext:ResourceManager ID="ResourceManager1" runat="server" Theme="Gray" Locale="tr-TR" GZip="true" />
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="İndirimler Komisyonlar" Layout="FitLayout" Icon="ShapeMoveBackwards" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString" AutoExpandColumn="ad" OnBeforeClientInit="GridPanelYuklenmedenOnce" AnchorHorizontal="100%" Region="Center" AutoScroll="true" MonitorResize="true" TrackMouseOver="true">
						<Store>
							<ext:Store ID="Store1" runat="server" OnRefreshData="KayitlariYenile" OnAfterRecordDeleted="KayitSil" RemoteSort="true">
								<Proxy>
									<ext:PageProxy />
								</Proxy>
								<AutoLoadParams>
								...
								<Reader>
									<ext:JsonReader IDProperty="id">
										<Fields>
											...
											<ext:RecordField Name="yuzde" Type="Float" />
						...
						<ColumnModel runat="server">
							<Columns>
								<ext:RowNumbererColumn MenuDisabled="true" ColumnID="check" Resizable="false" Editable="false" Width="55" />
								<ext:Column DataIndex="id" Header="ID" />
								<ext:Column DataIndex="ad" Header="Ad" />
								<ext:Column DataIndex="yuzde" Header="Yüzde" Width="55" MenuDisabled="true" Sortable="false" />
                                <ext:Column DataIndex="odeme_sekli" Header="Ödeme Şekli" />
                                <ext:Column DataIndex="tip" Header="Tip" />
								<ext:Column DataIndex="ekleyen" Header="Ekleyen" />
								<ext:DateColumn DataIndex="tarih_ek" Header="Kayıt Tarihi" Align="Center" Format="dd/MM/yyyy - HH:mm:ss" Width="125" />
								<ext:Column DataIndex="guncelleyen" Header="Güncelleyen" />
								<ext:DateColumn DataIndex="tarih_gun" Header="Güncelleme Tarihi" Align="Center" Format="dd/MM/yyyy - HH:mm:ss" Width="125" />
								<ext:CommandColumn Header="İşlemler" Align="Center" Width="55" MenuDisabled="true" Resizable="false" ButtonAlign="Center">
									<Commands>
								...
								<ext:CommandColumn Header="İK" Align="Center" Width="28" MenuDisabled="true" Resizable="false" ButtonAlign="Center">
									<Commands>
						...
						<Plugins>
							<ext:GridFilters runat="server" ID="GridFilters1" Local="true">
								<Filters>
                                    ...
                                    <ext:StringFilter DataIndex="yuzde" />
                                    <ext:StringFilter DataIndex="odeme_sekli" />
                                    <ext:StringFilter DataIndex="tip" />
			...
			<ext:Window ID="WindowEkle" runat="server" Modal="false" Resizable="True" Height="500" Icon="Add" Title="Ekle" Width="640" Padding="5" Layout="FormLayout" ButtonAlign="Center" Shadow="None" LabelSeparator=" : " Draggable="True" AutoFocus="True" AutoHeight="True" Hidden="true">
				<Items>
                    <ext:ComboBox ID="Ekle_ComboBoxOdemeSekli" Selectable="true" FieldLabel="Ödeme Şekli" AnchorHorizontal="96%" runat="server" DisplayField="ad" ValueField="id" Editable="true" Mode="Local" ForceSelection="true" SelectOnFocus="true" EmptyText="Ödeme Şeklini Seçiniz..." IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" AllowBlank="false">
								<Store>
									<ext:Store ID="StoreOdemeSekli1" runat="server" WarningOnDirty="false">
										<Reader>
											<ext:JsonReader>
												<Fields>
													<ext:RecordField Name="id" Type="Int" />
					...
					<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Ekle_TextFieldAd" MaxLength="255" MaxLengthText="Maksimum karakter sınırını aştınız." runat="server" FieldLabel="Adı" BlankText="Lütfen indirim adı yazın." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" EnableKeyEvents="true">
						<Listeners>
							<KeyUp Handler="this.setValue(this.getValue().toUpperCase());" />
						</Listeners>
					</ext:TextField>
                    <ext:TextField MsgTarget="Side" AllowBlank="false" MaskRe="[0-9]" ID="Ekle_TextFieldYuzde" MaxLength="10" MaxLengthText="Maksimum karakter sınırını aştınız." runat="server" FieldLabel="Yüzde" BlankText="Lütfen yüzdeyi yazın." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" EnableKeyEvents="true"></ext:TextField>
					<ext:ComboBox ID="Ekle_ComboBoxTip" runat="server" FieldLabel="Komisyon Tipi" Editable="false" Selectable="true">
						<Items>
							<ext:ListItem Text="KOMİSYON" Value="1" />
							<ext:ListItem Text="İNDİRİM" Value="0" />
						</Items>
			...
			<ext:Window ID="WindowDuzenle" runat="server" Modal="true" Resizable="True" Height="500" Icon="NoteEdit" Title="Düzenle" Width="640" Padding="5" Layout="FormLayout" ButtonAlign="Center" Shadow="None" LabelSeparator=" : " Draggable="True" AutoFocus="True" AutoHeight="True" Hidden="true">
				<Items>
					...
					<ext:TextField ID="Duzenle_Ad" Hidden="true" runat="server" />
                    <ext:ComboBox ID="Duzenle_ComboBoxOdemeSekli" Selectable="true" FieldLabel="Ödeme Şekli" AnchorHorizontal="96%" runat="server" DisplayField="ad" ValueField="id" Editable="true" Mode="Local" ForceSelection="true" SelectOnFocus="true" EmptyText="Ödeme Şeklini Seçiniz..." IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" AllowBlank="false">
								<Store>
									<ext:Store ID="StoreOdemeSekli2" runat="server" WarningOnDirty="false">
										<Reader>
											<ext:JsonReader>
												<Fields>
													<ext:RecordField Name="id" Type="Int" />
					...
					<ext:TextField MsgTarget="Side" AllowBlank="false" ID="Duzenle_TextFieldAd" MaxLength="255" MaxLengthText="Maksimum karakter sınırını aştınız." runat="server" FieldLabel="Adı" BlankText="Lütfen indirim adı yazın." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" EnableKeyEvents="true">
						<Listeners>
							<KeyUp Handler="this.setValue(this.getValue().toUpperCase());" />
						</Listeners>
					</ext:TextField>
                    <ext:TextField MsgTarget="Side" AllowBlank="false" MaskRe="[0-9]" ID="Duzenle_TextFieldYuzde" MaxLength="10" MaxLengthText="Maksimum karakter sınırını aştınız." runat="server" FieldLabel="Yüzde" BlankText="Lütfen yüzdeyi yazın." AnchorHorizontal="96%" IndicatorIcon="BulletStar" IndicatorTip="Zorunlu alan" EnableKeyEvents="true"></ext:TextField>
					<ext:ComboBox ID="Duzenle_ComboBoxTip" runat="server" FieldLabel="Komisyon Tipi" Editable="false" Selectable="true">
						<Items>
							<ext:ListItem Text="KOMİSYON" Value="1" />
							<ext:ListItem Text="İNDİRİM" Value="0" />
						</Items>
