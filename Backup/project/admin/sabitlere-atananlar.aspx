<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sabitlere-atananlar.aspx.cs" Inherits="SHOP.admin.sabitlere_atananlar" EnableViewState="False" ViewStateMode="Disabled"
...
<script src="js/js.js" type="text/javascript"></script>
	<script type="text/javascript"> 
	    var EkleSabitlerDegistir = function (t) {
	        Ext.net.DirectMethods.DM_EkleSabitlerDegistir(t);
	    }
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_textler&kayit_id=" + record.data.id);
	                break;
