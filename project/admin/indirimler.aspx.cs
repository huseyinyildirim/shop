...
{
    public partial class indirimler : System.Web.UI.Page
    {
        ...
        protected bool IndirimKontrol(string Ad)
        {
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                int EID = (from p in db.tbl_indirimler
                           where p.ad == Ad
        ...
        protected void Veriler(int Baslangic, int Bitis, string s, string Kolon, string AscDesc, out IList Sonuc1, out IList Sonuc2)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                try
                {
                    ...
                    #region İlk (Ham) SQL
                    var SQL1 = (from p in db.tbl_indirimler
                                select new
                                {
                                    p.id,
                                    p.ad,
        ...
        {
            if (!IndirimKontrol(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldAd.Text.Trim()).ToUpper()))
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    ...
                    tbl_indirimler ta = new tbl_indirimler();
        ...
        public void DM_GuncellemeEkraniGetir(int ID)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL2 = (from p in db.tbl_indirimler
                            where p.id == ID
                            select new
                            {
                                p.id,
        ...
        protected void GuncellemeYap(object sender, DirectEventArgs e)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                ...
                tbl_indirimler ta = (from p in db.tbl_indirimler where p.id == PID select p).FirstOrDefault();
                ...
                if (Duzenle_Ad.Text != Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_TextFieldAd.Text.Trim()).ToUpper())
                {
                    if (!IndirimKontrol(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_TextFieldAd.Text.Trim()).ToUpper()))
                    {
                        db.SaveChanges();
                    ...
                    {
                        Class.Fonksiyonlar.ExtJS.MesajKutusu(Icon.Error, MessageBox.Icon.ERROR, "İşlem başarısız", "Aynı indirimden mevcut.<br/>Lütfen farklı bir indirim adı belirtin!");
                        return;
                    }
                }
            }
        ...
        public void DM_OnayKaldir(int ID)
        {
            ...
            else
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    tbl_indirimler ta = (from p in db.tbl_indirimler where p.id == ID select p).FirstOrDefault();
