<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sanal-pos-para-birim.aspx.cs" Inherits="SHOP.admin.sanal_pos_para_birim" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
...
<script src="js/js.js" type="text/javascript"></script>
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Sanal Pos Para Birimleri" Layout="FitLayout" Icon="Neighbourhood" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString" AutoExpandColumn="kisaltma" OnBeforeClientInit="GridPanelYuklenmedenOnce" AnchorHorizontal="100%" Region="Center" AutoScroll="true" MonitorResize="true" TrackMouseOver="true">
						<Store>
							<ext:Store ID="Store1" runat="server" OnRefreshData="KayitlariYenile"
								...
								<SortInfo Field="kisaltma" Direction="ASC" />
								<Reader>
									<ext:JsonReader IDProperty="id">
										<Fields>
											<ext:RecordField Name="id" Type="Int" />
                                            <ext:RecordField Name="sanal_pos_id" />
						...
						<ColumnModel ID="ColumnModel1" runat="server">
							<Columns>
								...
								<ext:Column DataIndex="sanal_pos_id" Header="Sanal Pos" />
                                <ext:Column DataIndex="para_birim" Header="Para Birim" />
						...
						<Plugins>
							<ext:GridFilters runat="server" ID="GridFilters1" Local="true">
								<Filters>
									...
									<ext:StringFilter DataIndex="sanal_pos_id" />
                                    <ext:StringFilter DataIndex="para_birim" />
