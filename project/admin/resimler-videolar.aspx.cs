...
{
    public partial class resimler_videolar : System.Web.UI.Page
    {
        ...
        [DirectMethod]
        public string DM_Ekle_NodeYukle(string NodeID)
        {
        ...
        [DirectMethod]
        public void DM_Ekle_KategoriDegistir()
        {
            Ekle_TreePanelKategoriler.ReloadAsyncNode("0", null);
        }

        [DirectMethod]
        public string DM_Duzenle_NodeYukle(string NodeID)
        {
            int INodeID = int.Parse(NodeID);
            TreeNodeCollection TNC = new TreeNodeCollection();
        ...
        [DirectMethod]
        public void DM_Duzenle_KategoriDegistir()
        {
        ...
        protected string Kategoriler(int ResimID)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL = (from p in db.tbl_dosyalar_kategoriler
                           where p.dosya_id == ResimID
                           select new
                           {
                               kat = (p.kategori_id != null ? db.tbl_dosyalar_kategori.Where(k => k.id == p.kategori_id).Select(k => k.ad).FirstOrDefault() : null)
                           });
        ...
        protected List<int> KategorilerList(int ResimID)
        {
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                return (from p in db.tbl_dosyalar_kategoriler
                        where p.dosya_id == ResimID
        ...
        protected void YeniKayitYap(object sender, DirectEventArgs e)
        {
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                ...
                int tip = int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxTip.Value.ToString().Trim()));
                ...
                if (tip == 0)
                {
                    ...
                    {
                        ta1.ad = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxResim.Value.ToString().Trim());
                    }
                }
                else if (tip == 1)
                {
                    ta1.ad = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldAdi.Text.Trim());
                    ta1.url = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldUrl.Text.ToString().Trim());
                }
                ...
                if (Ekle_TextAreaAciklama.Text != null)
                {
                    ...
                    {
                        ta1.aciklama = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextAreaAciklama.Text.Trim());
                    }
                    else
                    {
                        ta1.aciklama = null;
                ...
                foreach (var i in Ekle_TreePanelKategoriler.CheckedNodes)
                {
                    ...
                    ta2.dosya_id = ta1.id;
                    ta2.kategori_id = int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, i.NodeID));
                    ta2.admin_id_ek = Class.Fonksiyonlar.Admin.Genel.AdminID();
                    db.AddTotbl_dosyalar_kategoriler(ta2);
                    db.SaveChanges();
        ...
        public void DM_GuncellemeEkraniGetir(int ID)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL2 = (from p in db.tbl_dosyalar
                            where p.id == ID
                            select new
                            {
                                p.ad,
        ...
        protected void GuncellemeYap(object sender, DirectEventArgs e)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                ...
                tbl_dosyalar ta1 = (from p in db.tbl_dosyalar where p.id == PID select p).FirstOrDefault();
                ...
                {
                    ta1.ad = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_TextFieldAdi.Text.Trim());
                    ta1.url = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_TextFieldUrl.Text.ToString().Trim());
                }
                ...
                if (Duzenle_TextAreaAciklama.Text != null)
                {
                    ...
                    {
                        ta1.aciklama = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_TextAreaAciklama.Text.Trim());
                    }
                    else
                    {
                        ta1.aciklama = null;
                ...
                if (Duzenle_TreePanelKategoriler.CheckedNodes != null)
                {
                    ...
                    if (ListKategoriler.Count > 0)
                    {
                        ...
                        {
                            tbl_dosyalar_kategoriler tta2 = (from p in db.tbl_dosyalar_kategoriler where p.kategori_id == j && p.dosya_id == ta1.id select p).FirstOrDefault();
            ...
            if (RSM.SelectedRows.Count > 0)
            {
                for (int i = 0; i < RSM.SelectedRows.Count; i++)
                {
                    using (BaglantiCumlesi db = new BaglantiCumlesi())
                    {
                        ...
                        tbl_dosyalar ta = (from p in db.tbl_dosyalar where p.id == PID select p).FirstOrDefault();
                        db.DeleteObject(ta);
        ...
        public void DM_OnayKaldir(int ID)
        {
            ...
            else
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    tbl_dosyalar ta = (from p in db.tbl_dosyalar where p.id == ID select p).FirstOrDefault();
            ...
            switch (M.Type)
            {
                case Class.Sabitler.MessageTypes.OK:
                    ...
                    using (BaglantiCumlesi db = new BaglantiCumlesi())
                    {
                        ...
                        #region Dosya Kaydet
                        string ResimAdi = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.StringTemizle, GelenDosya.FileName);
