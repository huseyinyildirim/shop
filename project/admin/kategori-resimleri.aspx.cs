...
{
    public partial class kategori_resimleri : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    VerileriGetir();
                    Label2.Html = "İlgili resimler " + "<b><u>" + Class.Degiskenler.Site.Yollar.Kategori + "</u></b>" + " klasöründen gösterilmektedir.";
                }
                #endregion
            }
            #endregion
