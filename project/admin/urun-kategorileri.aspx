<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="urun-kategorileri.aspx.cs" Inherits="SHOP.admin.urun_kategorileri" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
	...
	<script type="text/javascript"> 
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_kategoriler&kayit_id=" + record.data.id);
	                break;
	    ...
	    var ResimYol = function (data) {
	        if (data != null) { 
	            return String.format("<a href=\"" + data.replace(data, "../userfiles/categori/" + data) + "\" target=\"_blank\">" + data + "</a>");
	        }
	    };
	</script>
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
					...
					<ext:BorderLayout ID="BorderLayout1" runat="server">
						...
						<Center>
							<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString" AutoExpandColumn="ad"
								...
								<Buttons>
								<ext:Button runat="server" ID="Button6" Text="Dosya Yükle" Icon="Attach">
								<DirectEvents>
			...
			<ext:Window ID="WindowSiralama" runat="server" Modal="true" Resizable="True" Height="500"
				...
				<Buttons>
					<ext:Button ID="Button7" runat="server" Text="Gönder" Icon="Accept" Type="Submit">
						<Listeners>
