...
{
    public partial class bottom_header_resim_islemleri : System.Web.UI.Page
    {
        ...
        {
            StoreAdi.DataSource = AdminClass.ResimleriGetir(Class.Degiskenler.Site.Yollar.Diger, "D");
            StoreAdi.DataBind();
        }
        ...
        protected bool KayitKontrol(int DilID, int Yer, int Konum)
        {
            ...
            {
                int EID = (from p in db.tbl_ikonlar
        ...
        protected void Veriler(int Baslangic, int Bitis, string s, string Kolon, string AscDesc, out IList Sonuc1, out IList Sonuc2)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                try
                {
                    ...
                    #region İlk (Ham) SQL
                    var SQL0 = (db.tbl_ikonlar).AsEnumerable();
        ...
        {
            if (!KayitKontrol(int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxDil.Value.ToString().Trim())), int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxYer.Value.ToString().Trim())), int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxKonum.Value.ToString().Trim()))))
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    ...
                    ta.alt = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldBaslik.Text.ToString().Trim());
                    ta.ikon = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxResim.Value.ToString().Trim());
                    ta.yer = int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxYer.Value.ToString().Trim()));
                    ta.konum = int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_ComboBoxKonum.Value.ToString().Trim()));
                    ta.admin_id_ek = Class.Fonksiyonlar.Admin.Genel.AdminID();
                    ta.onay = OnayBool;
                    db.AddTotbl_ikonlar(ta);
                    db.SaveChanges();
            ...
            {
                Class.Fonksiyonlar.ExtJS.MesajKutusu(Icon.Error, MessageBox.Icon.ERROR, "İşlem başarısız", "Aynı dile ait kayıt mevcut.<br/>Lütfen farklı bir dil belirtin!");
                return;
            }
        }
        ...
        public void DM_GuncellemeEkraniGetir(int ID)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL2 = (from p in db.tbl_ikonlar
                            where p.id == ID
                            select new
                            {
                                p.dil_id,
        ...
        {
            if (!KayitKontrol(int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxDil.Value.ToString().Trim())), int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxYer.Value.ToString().Trim())), int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxKonum.Value.ToString().Trim()))))
            {
                #region Onay Boolean Çevirme
                bool OnayBool = false;
                ...
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    ...
                    tbl_ikonlar ta = (from p in db.tbl_ikonlar where p.id == PID select p).FirstOrDefault();
                    ta.dil_id = int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxDil.Value.ToString().Trim()));
                    ta.alt = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_TextFieldBaslik.Text.ToString().Trim());
                    ta.ikon = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxResim.Value.ToString().Trim());
                    ta.yer = int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxYer.Value.ToString().Trim()));
                    ta.konum = int.Parse(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Duzenle_ComboBoxKonum.Value.ToString().Trim()));
                    ta.onay = OnayBool;
        ...
        public void DM_OnayKaldir(int ID)
        {
            ...
            else
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    tbl_ikonlar ta = (from p in db.tbl_ikonlar where p.id == ID select p).FirstOrDefault();
