<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kodlar-scriptler.aspx.cs" Inherits="SHOP.admin.kodlar_scriptler" EnableViewState="False" ViewStateMode="Disabled"
	...
	<script type="text/javascript"> 
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_scriptler&kayit_id=" + record.data.id);
	                break;
