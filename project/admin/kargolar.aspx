<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kargolar.aspx.cs" Inherits="SHOP.admin.kargolar" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
...
<script src="js/js.js" type="text/javascript"></script>
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Kargolar" Layout="FitLayout" Icon="Neighbourhood" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString" AutoExpandColumn="ad"
								...
								<Reader>
									<ext:JsonReader IDProperty="id">
										<Fields>
											...
											<ext:RecordField Name="km_birim_fiyat" />
                                            <ext:RecordField Name="desi_birim_fiyat" />
                                            <ext:RecordField Name="sabit_fiyat" />
                                            <ext:RecordField Name="ucretsiz_fiyat" />
                                            <ext:RecordField Name="ucretsiz_desi" />
										</Fields>
									</ext:JsonReader>
								</Reader>
							</ext:Store>
						...
						<ColumnModel ID="ColumnModel1" runat="server">
							<Columns>
								...
								<ext:Column DataIndex="tip" Header="Tipi" />
								<ext:Column DataIndex="ad" Header="Firma Adı" />
								<ext:Column DataIndex="ikon" Header="İkon" />
                                <ext:Column DataIndex="url" Header="URL" />
                                <ext:Column DataIndex="km_birim_fiyat" Header="KM. Birim Fiyatı" />
                                <ext:Column DataIndex="desi_birim_fiyat" Header="Desi Birim Fiyatı" />
                                <ext:Column DataIndex="sabit_fiyat" Header="Sabit Fiyat" />
                                <ext:Column DataIndex="ucretsiz_fiyat" Header="Ücretsiz Fiyatı" />
                                <ext:Column DataIndex="ucretsiz_desi" Header="Ücretsiz Desi" />
							</Columns>
						</ColumnModel>
						<Plugins>
							<ext:GridFilters runat="server" ID="GridFilters1" Local="true">
								<Filters>
									...
									<ext:StringFilter DataIndex="ikon" />
                                    <ext:StringFilter DataIndex="url" />
									<ext:StringFilter DataIndex="km_birim_fiyat" />
                                    <ext:StringFilter DataIndex="desi_birim_fiyat" />
                                    <ext:StringFilter DataIndex="sabit_fiyat" />
                                    <ext:StringFilter DataIndex="ucretsiz_fiyat" />
                                    <ext:StringFilter DataIndex="ucretsiz_desi" />
								</Filters>
							</ext:GridFilters>
						</Plugins>
						<SelectionModel>
