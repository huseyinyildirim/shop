...
{
    public partial class firma_adresleri : System.Web.UI.Page
    {
        ...
        protected void Veriler(int Baslangic, int Bitis, string s, string Kolon, string AscDesc, out IList Sonuc1, out IList Sonuc2)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                try
                {
                    ...
                    #region İlk (Ham) SQL
                    var SQL1 = (from p in db.tbl_firma_adresler
                                select new
                                {
                                    p.id,
                                    p.ulke_id,
        ...
        protected void YeniKayitYap(object sender, DirectEventArgs e)
        {
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                ...
                ta.adres = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextAreaAdres.Text.Trim());

                if (Ekle_TextFieldBaslik.Text != null)
                {
                    ta.baslik = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldBaslik.Text.Trim()).ToUpper();
                }
                else
                {
                    ta.baslik = null;
                ...
                {
                    if (!string.IsNullOrEmpty(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldHaritaURL.Text.Trim())))
                    {
                        ta.harita_url = Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, Ekle_TextFieldHaritaURL.Text.Trim());
                    }
                    else
                    {
                        ta.harita_url = null;
        ...
        public void DM_GuncellemeEkraniGetir(int ID)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                var SQL2 = (from p in db.tbl_firma_adresler
                            where p.id == ID
                            select new
                            {
                                p.id,
        ...
        protected void SiralamaGuncelle(object sender, DirectEventArgs e)
        {
            ...
            using (BaglantiCumlesi db = new BaglantiCumlesi())
            {
                ...
                if (YeniSira != 0)
                {
                    ...
                    if (SQL.Any())
                    {
                        tbl_firma_adresler td1 = (from p in db.tbl_firma_adresler where p.sira == YeniSira select p).FirstOrDefault();
                        td1.sira = 0;
                    ...
                    tbl_firma_adresler td2 = (from p in db.tbl_firma_adresler where p.id == PID select p).FirstOrDefault();
                    td2.sira = YeniSira;
                ...
                {
                    tbl_firma_adresler td3 = (from p in db.tbl_firma_adresler where p.id == PID select p).FirstOrDefault();
                    td3.sira = 0;
        ...
        public void OnayKaldir(int ID)
        {
            ...
            else
            {
                using (BaglantiCumlesi db = new BaglantiCumlesi())
                {
                    tbl_firma_adresler ta = (from p in db.tbl_firma_adresler where p.id == ID select p).FirstOrDefault();
