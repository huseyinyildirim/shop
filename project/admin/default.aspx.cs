    ...
    public partial class _default : System.Web.UI.Page
    {
        ...
        protected void GirisYap(object sender, DirectEventArgs e)
        {
            if (Class.Fonksiyonlar.Firma.Ayar().Select(p => p.mode).FirstOrDefault() == false)
            {
                ...
                {
                    Class.Fonksiyonlar.ExtJS.MesajKutusu(Icon.Error, MessageBox.Icon.ERROR, "Local Mode", "Girdiğiniz kullanıcı bilgileri Local Mode aittir.<br/>Lütfen başka kullanıcı bilgilerini deneyiniz.");
                }
                else
                {
                    KullaniciAdiKontrol();
        ...
        {
            if (Class.Fonksiyonlar.Admin.Kullanici.Kontroller.KullaniciAdi(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, txtUsername.Text.Trim())))
            {
                OnayKontrol();
            }
            else
            {
                ...
                Class.Fonksiyonlar.Admin.Log.Hatalar(null, Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, txtUsername.Text.Trim()), (int)Class.Sabitler.AdminLog.Hatalar.KullaniciYok, (int)Class.Sabitler.KullaniciTip.Admin);
                #endregion
        ...
        {
            if (Class.Fonksiyonlar.Admin.Kullanici.Kontroller.Onay(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, txtUsername.Text.Trim())))
            {
                SifreKontrol();
            }
            else
            {
                #region Admin Hata Log
                Class.Fonksiyonlar.Admin.Log.Hatalar(null, Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, txtUsername.Text.Trim()), (int)Class.Sabitler.AdminLog.Hatalar.OnayYok, (int)Class.Sabitler.KullaniciTip.Admin);
                #endregion
        ...
        {
            if (Class.Fonksiyonlar.Admin.Kullanici.Kontroller.Sifre(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, txtUsername.Text.Trim()), Class.Fonksiyonlar.Admin.Genel.SifreOlustur(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, txtPassword.Text.Trim()))))
            {
                #region Admin Session Ver
                if (!Class.Fonksiyonlar.Admin.Genel.SessionKontrol())
                {
                    Objeler.Tanimlar.Admin D = new Objeler.Tanimlar.Admin();
                    D.ID = Class.Fonksiyonlar.Admin.Kullanici.Cagir.ID(Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, txtUsername.Text.Trim()));
            ...
            {
                #region Admin Hata Log
                Class.Fonksiyonlar.Admin.Log.Hatalar(null, Class.Fonksiyonlar.Genel.StringIslemleri(Class.Sabitler.StringIslemleri.StringIslemTipleri.SQLTemizle, txtUsername.Text.Trim()), (int)Class.Sabitler.AdminLog.Hatalar.SifreYanlis, (int)Class.Sabitler.KullaniciTip.Admin);
                #endregion
