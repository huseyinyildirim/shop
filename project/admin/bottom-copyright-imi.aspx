<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bottom-copyright-imi.aspx.cs" Inherits="SHOP.admin.bottom_copyright_imi" EnableViewState="False" ViewStateMode="Disabled"
	...
	<script type="text/javascript"> 
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_bottomlar&kayit_id=" + record.data.id);
	                break;
