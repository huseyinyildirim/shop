<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bottom-header-resimleri.aspx.cs"
    Inherits="SHOP.admin.bottom_header_resimleri" EnableViewState="False" ViewStateMode="Disabled"
    ...
    <ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
        <Items>
            <ext:Window ID="Window1" runat="server" Maximized="true" Title="Bottom Header Resimleri [K]"
                Layout="FitLayout" Icon="PicturesThumbs" Closable="false" Minimizable="false"
