<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kredi-karti-tip.aspx.cs" Inherits="SHOP.admin.kredi_karti_tip" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
...
<script src="js/js.js" type="text/javascript"></script>
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Kredi Kartı Tipleri" Layout="FitLayout" Icon="Neighbourhood" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString" AutoExpandColumn="ad" OnBeforeClientInit="GridPanelYuklenmedenOnce" AnchorHorizontal="100%" Region="Center" AutoScroll="true" MonitorResize="true" TrackMouseOver="true">
						...
						<ColumnModel ID="ColumnModel1" runat="server">
							<Columns>
								...
								<ext:Column DataIndex="ad" Header="Kredi Kart Tip Adı" />
							</Columns>
						</ColumnModel>
						<Plugins>
