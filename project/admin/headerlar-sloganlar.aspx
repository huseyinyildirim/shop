<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="headerlar-sloganlar.aspx.cs" Inherits="SHOP.admin.headerlar_sloganlar" EnableViewState="False" ViewStateMode="Disabled"
...
<script src="js/js.js" type="text/javascript"></script>
	<script type="text/javascript"> 
	    var HeaderYol = function (data) {
	        return String.format("<a href=\"" + data.replace(data, "../userfiles/header/" + data) + "\" target=\"_blank\">" + data + "</a>");
	    };
	    ...
	    var GridKomutlari = function (cmd, record) {
	        switch (cmd) {
	            ...
	            case "IslemKaydi":
	                PencereGetir("WindowY" + record.data.id, "icon-usercomment", "İşlem Kayıtlarını Gösterim Penceresi - " + record.data.id, "Kayıtlar yükleniyor...", "isleme-ait-kayitlar.aspx?tablo_adi=tbl_headerlar&kayit_id=" + record.data.id);
	                break;
