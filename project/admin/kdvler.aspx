<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kdvler.aspx.cs" Inherits="SHOP.admin.kdvler" EnableViewState="False" ViewStateMode="Disabled" EnableEventValidation="False" ValidateRequest="false" %>
...
<script src="js/js.js" type="text/javascript"></script>
	...
	<ext:Viewport ID="Viewport1" runat="server" Layout="FitLayout" StyleSpec="background-color:#F0F0F0">
		<Items>
			<ext:Window ID="Window1" runat="server" Maximized="true" Title="Kdvler" Layout="FitLayout" Icon="Neighbourhood" Closable="false" Minimizable="false" MinHeight="480" MinWidth="640">
				<Items>
					<ext:GridPanel ID="GridPanel1" runat="server" ColumnLines="true" SortType="AsUCString" AutoExpandColumn="ad"
						...
						<ColumnModel ID="ColumnModel1" runat="server">
							<Columns>
								...
								<ext:Column DataIndex="yuzde" Header="Yüzde" />
							</Columns>
						</ColumnModel>
						<Plugins>
